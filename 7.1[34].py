...
letters_for_check = set("аяуюоеёэиы")

def rythm_check (poem: str):
    check_set_count = set()
    for word in poem.split():
        count = 0
        for letter in word:
            if letter in letters_for_check:
                count += 1
        check_set_count.add(count)
    if len(check_set_count) == 1: return True
    else: return False



print(rythm_check("пара-ра-рам рам-пам-папам па-ра-па-дам"))
print(rythm_check("пара-ра-рам рам-пум-пупам па-ре-по-дам"))
